...
public interface MaintenanceRequestService {
    ...
    PageResponse<MaintenanceRequestResponse> getRequests(String keyword, int page, int size, UUID requesterId);
    List<MaintenanceRequestResponse> getAllRequests(String keyword, UUID requesterId);
