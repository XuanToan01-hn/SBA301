...
public interface BuildingMapper {
    ...
    // Sử dụng building.tên_thuộc_tính để MapStruct xác định đúng nguồn
    ...
    // Đối với phương thức 1 tham số, MapStruct có thể tự tìm trong 'building'
    // Nhưng tốt nhất nên nhất quán hoặc đặt tên target/source giống hệt nhau
